...
object RepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideMainRepository(workoutDao: WorkoutDao): ExercisesRepository {
        return ExercisesRepository(ExercisesRemoteDataSource(), ExerciseLocalDataSource(workoutDao))
    }
